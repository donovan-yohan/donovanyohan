        ...
        <div className="pageContent">
          ...
          <Article>
            ...
            <div className="imageWrapper">
              {logos.map(({ key, src, label, width, invertForDarkMode, isVideo }) => {
                return (
                  <div key={key} className="image" style={{ flexBasis: width + "%" }}>
                    {isVideo && (
                      <video
                        ...
                        poster={
                          src.poster
                            ? "/img/photos/work/graphicdesign/logos/" + src.poster
                            : undefined
                        }
                      >
                        <source
                          src={"/img/photos/work/graphicdesign/logos/" + src.light}
                          type="video/webm"
                        />
          ...
          <Article>
            ...
            <div className="imageWrapper">
              {promotions.map(({ key, src, label, width, invertForDarkMode, isVideo }) => {
                return (
                  <div key={key} className="image" style={{ flexBasis: width + "%" }}>
                    {isVideo && (

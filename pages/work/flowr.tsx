    ...
    >
      <div className="pageRoot">
        <div className="pageContent">
          ...
          <Article>
            <p className="body">
              As one of my first user-centered projects, I picked something where I could use my own
              experience as a significant research resource. From there, I was able to create a
              concept that I would go on to iterate and gain feedback on.
            </p>
            ...
            <ul className="body tableOfContents">
              ...
              <li>
                <a href="">Spending time on the problem makes the solution clear</a>
              </li>
            </ul>
          </Article>
          ...
          <Article>
            ...
            <p className="body">
              ...
              exceptuer. Occaecat cillum reprehenderit cillum culpa officia officia esse laborum
              pariatur. Nisi deserunt ipsum sunt officia ea occaecat anim sunt.
            </p>
          </Article>

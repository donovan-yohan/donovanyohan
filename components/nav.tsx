    ...
    <nav>
      <ul>
        <div className="homeLink">
          ...
          {props.breadcrumbs &&
            props.breadcrumbs.map(({ href, label }) => {
              return (
                <li className="breadcrumb" key={"nav-breadcrumb-" + label + href}>
                  <span className="divider">/</span>
                  <a href={href} className={"highlight path"}>
                    {label}
                  </a>
                </li>
              );
        ...
        <div className="navLinks">
          ...
          <li>
            <a href={contactRoute} className="highlight">
              Contact
            </a>
          </li>
        </div>
      ...
      <div
        ...
        onMouseEnter={() => {
          if (lottieRef.current) {
            lottieRef.current.setDirection((1 * themeMultiplier) as 1 | -1);

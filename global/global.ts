...
export const projects: Project[] = [
  ...
  {
    src: ["", "img/photos/cards/cooperators/coop00.png", "img/photos/cards/cooperators/coop10.png"],
  ...
  {
    src: ["", "img/photos/cards/flowr/flowr00.png", "img/photos/cards/flowr/flowr10.png"],
    href: "/work/flowr",
    label: "flowr",
...
].map((project) => ({ ...project, key: `nav-link-${project.href}-${project.label}` }));
...
].map((hobby) => ({ ...hobby, key: `nav-link-${hobby.href}-${hobby.label}` }));

...
export const projects = [
  ...
  },
  {
    ...
    content:
      "Ah, the portfolio. How do you design something that's never finished and that nobody can seem to agree on how to do? In my approach, I carefully designed the problem before creating my solution."
  },
  {
    ...
    content:
      "I've been running a small business for selling customized graphic apparel and stickers since highschool. As both a design & programming challenge, I wanted to build a webstore from the ground up to market and sell my work."
  },
  {
    href: "/work/flowr",
    label: "flowr",
    ...
    content:
      "Part passion project, part I-had-to-do-this-because-my-gpa-would-suffer-if-I-didn't, flowr is a time management tool that focuses on students, and their pain points with existing digital calendars."
  },
  {

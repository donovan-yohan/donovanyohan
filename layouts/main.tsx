...
const cssRootVars: Record<string, string> = {
  background: "#ffffff",
  main: "#000000",
  highlight: "#FFEF00",
  gray: "#757575",
...
const cssDarkVars: Record<string, string> = {
  background: "#000000",
  main: "#ffffff",
  highlight: "#5a3ec8",
  gray: "#bcbcbc",
...
const Main = (props: MainProps) => {
  ...
  return (
    <div>
      ...
      {props.children}
      <Footer />
      {windowWidth !== null && windowWidth <= MobileWidth && <BottomNav />}
      <style jsx global>{`
        @font-face {
          font-family: "icomoon";
          src: url("/img/icons/icomoon.eot?c46m5p");
          src:
            url("/img/icons/icomoon.eot?c46m5p#iefix") format("embedded-opentype"),
